...
<img src="{=site.url('images/posts/graphql-on-wildfly-swarm/membership.png')}" alt="high-level">
...
<img src="{=site.url('images/posts/graphql-on-wildfly-swarm/swagger_screenshot.png')}" alt="swagger-ui">
...
<img src="{=site.url('images/posts/graphql-on-wildfly-swarm/graphiql_screenshot.png')}" alt="swagger-ui">
...
The [MembershipErrorHandler](https://github.com/phillip-kruger/membership/blob/master/src/main/java/com/github/phillipkruger/membership/graphql/MembershipErrorHandler.java) translates a ConstraintViolationException (that is thrown when the bean validation fails) and creates a nice error message for GraphQL.
