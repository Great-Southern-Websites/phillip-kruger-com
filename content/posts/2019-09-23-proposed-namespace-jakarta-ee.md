...
<img src="{=site.url('images/posts/proposed-namespace-jakarta-ee/current.png')}" alt="curent">
...
<img src="{=site.url('images/posts/proposed-namespace-jakarta-ee/proposed.png')}" alt="curent">
...
<img src="{=site.url('images/posts/proposed-namespace-jakarta-ee/legacy.png')}" alt="curent">
