...
image: posts/accidental-data/20160220_194214.jpg
---
...
<img src="{=site.url('images/posts/accidental-data/20160223_100932_hdr.jpg')}" alt="accidental data">
...
<img src="{=site.url('images/posts/accidental-data/20160223_131555.jpg')}" alt="iib">

## Traditional WAS vs Liberty (or should you be using Liberty)

Short answer (for us). Yes.

This talk went through the features of traditional WAS and Liberty. Some things that I found interesting:
