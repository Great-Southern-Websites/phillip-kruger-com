...
> able to move quickly and easily. “Ruth was as agile as a monkey” **synonyms:** nimble, lithe, supple, limber, acrobatic, fleet-footed, light-footed **antonyms:** clumsy, stiff, slow, dull
...
<img src="{=site.url('images/posts/monkey-methodology/waterfall_vs_agile.png')}" alt="speed">
...
That’s why it’s also better to think of a product rather than a project. A project usually has a start time, end time and a set of features. A product has versions and features and evolve over time. A Product might never be done. That’s OK. We are not building a house :) <img src="{=site.url('images/posts/monkey-methodology/waterfall_vs_agile2.jpg')}" alt="product">
...
Very important to give them the environment and freedom to get the job done. (see [Guerrilla programming]({=site.url('posts/guerrilla-programming')}))
