...
<img src="{=site.url('images/posts/some-bash-functions-for-git/clone_1.gif')}" alt="clone1">

`clone *url*`      , clone the repo at the url

<img src="{=site.url('images/posts/some-bash-functions-for-git/clone_2.gif')}" alt="clone1">

`clone`            , will ask for the repo name or url

<img src="{=site.url('images/posts/some-bash-functions-for-git/clone_3.gif')}" alt="clone1">
...
<img src="{=site.url('images/posts/some-bash-functions-for-git/sync.gif')}" alt="clone1">
...
<img src="{=site.url('images/posts/some-bash-functions-for-git/commit.gif')}" alt="clone1">
