...
<img src="{=site.url('images/posts/creativity-has-no-filter/javaeepi.jpg')}" alt=""> This talk by Payara guys [Ondrej Mihalyi](https://twitter.com/OMihalyi) and [Mike Croft](https://twitter.com/croft) debunked the myth that Java EE is heavy.
...
<img src="{=site.url('images/posts/creativity-has-no-filter/javaee8.jpg')}" alt="">
...
<img src="{=site.url('images/posts/creativity-has-no-filter/servlet4.jpg')}" alt="">
...
<img src="{=site.url('images/posts/creativity-has-no-filter/keynote.jpg')}" alt="">
...
- [Oracle](https://www.oracle.com) showed [Wercker](http://www.wercker.com/) - Build, deploy and operate container-native applications at scale
...
<img src="{=site.url('images/posts/creativity-has-no-filter/grow_up.jpg')}" alt="">
...
<img src="{=site.url('images/posts/creativity-has-no-filter/ee4j.jpg')}" alt="">
...
<img src="{=site.url('images/posts/creativity-has-no-filter/ee4j_2.jpg')}" alt="">
...
<img src="{=site.url('images/posts/creativity-has-no-filter/graphql.jpg')}" alt="">
...
Some Java libraries that enable this can be found here: https://github.com/graphql-java Some client side libraries (Android, JavaScript etc) can be found here:https://github.com/apollographql

**We need to seriously look at this!**

## JCP Party!

<img src="{=site.url('images/posts/creativity-has-no-filter/jcp_party.jpg')}" alt="">
