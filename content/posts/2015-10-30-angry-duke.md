...
date: 2015-10-30
tags: ["JavaOne 2015"]
image: posts/angry-duke/angry_1.jpg
---
...
Next they want to look at keeping your stream function up to date in real time! This sounds awesome, real time operations on huge data sets… <img src="{=site.url('images/posts/angry-duke/angry_2.jpg')}" alt="angry 2">
...
<img src="{=site.url('images/posts/angry-duke/angry_3.jpg')}" alt="angry 3">
...
<img src="{=site.url('images/posts/angry-duke/angry_4.jpg')}" alt="angry 4">
...
<img src="{=site.url('images/posts/angry-duke/angry_5.jpg')}" alt="angry 5">
