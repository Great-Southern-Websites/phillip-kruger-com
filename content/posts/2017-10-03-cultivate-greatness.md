...
<img src="{=site.url('images/posts/cultivate-greatness/mqtt.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/security.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/jca.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/duke.jpg')}" alt="">
...
http://www.jddarcy.org/Conferences/JavaOne/J1\_2017-jdk9-lang-tools-libs.pdf

## Architecting for Failure: Why Are Distributed Systems Hard?

<img src="{=site.url('images/posts/cultivate-greatness/distributing.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/cdi_ext.jpg')}" alt="">

## Developer Keynote

<img src="{=site.url('images/posts/cultivate-greatness/keynote.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/patterns.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/decorator.jpg')}" alt="">

## MVC 1.0: Community Involvement Matters!

Oracle decided to not include the new Action based view technology (MVC 1.0) in the Java EE 8 Spec, and handed over to [Ivar Grimstad](https://twitter.com/ivar_grimstad) who is now running with it.
...
<img src="{=site.url('images/posts/cultivate-greatness/mvc.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/ibm.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/p1.jpg')}" alt="">

The view

<img src="{=site.url('images/posts/cultivate-greatness/p2.jpg')}" alt="">
...
<img src="{=site.url('images/posts/cultivate-greatness/p3.jpg')}" alt="">
