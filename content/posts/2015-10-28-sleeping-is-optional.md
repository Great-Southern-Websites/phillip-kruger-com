...
date: 2015-10-28
tags: ["JavaOne 2015"]
image: posts/sleeping-is-optional/4_swag.jpg
---
...
<img src="{=site.url('images/posts/sleeping-is-optional/1_badge.jpg')}" alt="badge"> *(your badge has a barcode that has all your details on. To enter a session your badge needs to be scanned to see if you have access. Preference is given to people that have booked.)*
...
<img src="{=site.url('images/posts/sleeping-is-optional/screenshot_2015-10-28-05-26-13.png')}" alt="screenshot"> *(All your booked sessions, and some other info, are available on a mobile app.)*
...
This also means a new HTTP Client in Java SE that will be included in version 9 <img src="{=site.url('images/posts/sleeping-is-optional/5_vote.jpg')}" alt="vote"> *(after every talk you can rate the speaker and the talk. This will influence what you see next year)*
...
This talk was ‘suposingly’ trying to give a solution for cache invalidation. The first part of the talk defined the problem and the current known solutions and this was the great and interesting part. Current known solutions:
...
The take away for me was, do not believe the hype, you possibly do not need big data. But if you do beware of the vendors and the [big hammer syndrome](https://en.wikipedia.org/wiki/Law_of_the_instrument). <img src="{=site.url('images/posts/sleeping-is-optional/6_mic.jpg')}" alt="mic"> *(In some session rooms you can use you phone as a mic to ask questions)*
...
The general feeling though,  is  that the centralization of concerns, like what an ESB does is maybe not a good idea. <img src="{=site.url('images/posts/sleeping-is-optional/7_tshirt1.jpg')}" alt="tshirt1"> <img src="{=site.url('images/posts/sleeping-is-optional/7_tshirt3.jpg')}" alt="tshirt2"> <img src="{=site.url('images/posts/sleeping-is-optional/7_tshirt2.jpg')}" alt="tshirt3"> **(you can make your own t-shirt)**
...
<img src="{=site.url('images/posts/sleeping-is-optional/3_free_coffee.jpg')}" alt="coffee"> *(did I mention the free cappuccinos?)*
