...
<img src="{=site.url('images/posts/bask-in-positivity/adam1.jpg')}" alt="">

You can not attend a conference without going to an [Adam Bien](https://twitter.com/AdamBien) talk. This talk (available [here](https://www.youtube.com/watch?v=LwimkQQDhio)) debunked the myth that Java EE is Heavyweight.
...
<img src="{=site.url('images/posts/bask-in-positivity/adam2.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/module1.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/jsf.jpg')}" alt=""> Above one of the first JSF slides presented at JavaOne 16 years ago…
...
<img src="{=site.url('images/posts/bask-in-positivity/panel.jpg')}" alt="">
...
The API economy changed that and forced the industry to standardize. <img src="{=site.url('images/posts/bask-in-positivity/oauth1.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/cf.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/restsec.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/pi.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/portal.jpg')}" alt="">
...
<img src="{=site.url('images/posts/bask-in-positivity/fest1.jpg')}" alt=""> <img src="{=site.url('images/posts/bask-in-positivity/fest2.jpg')}" alt=""> <img src="{=site.url('images/posts/bask-in-positivity/fest3.jpg')}" alt="">
