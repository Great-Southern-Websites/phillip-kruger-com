...
slug: stompee
aliases: ["/post/stompee/"]
description: "A while back I decided to play a bit with WebSockets (JSR 356), but I wanted to do more than a “Hello World”, so Stompee was born"
thumb: site/stompee_logo.png
date: 2017-06-14
...
<img src="{=site.url('images/posts/stompee/stompee-ui-1.png')}" alt="screen1">
...
<img src="{=site.url('images/posts/stompee/stompee-ui-2.png')}" alt="screen2">
...
The level, filter and exception\_only options actually happen in the Log Handler on the server side, making the data that gets sent to the UI more efficient.

<img src="{=site.url('images/posts/stompee/stompee-ui-3.png')}" alt="screen3">
...
> **Why stompee?** The name stompee comes from stomp + ee. Stomp is the Afrikaans word for log (wooden) and ee for Java EE Stompie is the Afrikaans word for cigarette butt, hence the logo.
